...
export default class AlunoHomepage extends React.Component {
  ...
  handleClick(futurePage, event){
    ...
    console.log("mudou porra")
  }
  render() {
    return(
      this.state.page == "home" ?(
      <div className="topo">
        <FixedNavbar handleClick={this.handleClick}/>
        <Container>
          <Grid>
      ...
      :
      (this.state.page == "disciplinas" ? <div> <VerDisciplinas handleClick={this.handleClick}/> </div> : <div><FazerPreMatricula handleClick={this.handleClick}/> </div>)
    )
  }
